...
_ZKP_ can be used to construct protocols for _verifiable_ computations without full re-computing and without revealing an inputs. Thare are many constructions for that (_zkSNARKs_,_zkSTARKs_,_bulletproofs_, etc.).
